...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ref={ref}
      className={cn(
        "w-6 h-6 border-2 border-blue-600 bg-white rounded-full appearance-none cursor-pointer relative",
    ...
    >
      <RadioGroupPrimitive.Indicator className="flex items-center justify-center w-full h-full">
        <span className="block w-3 h-3 rounded-full bg-white shrink-0" />
